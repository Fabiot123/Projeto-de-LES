...
export default function FormClient({ cliente }) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <h2 className={styles.formSection}>Informações Pessoais</h2>
      ...
      >
        {addressFields.fields.map((val, index) => {
          return (
            ...
            >
              <CheckboxGroup
                value={watch(`endereco.[${index}].tipos`)}
                onChange={(value) =>
                  setValue(`endereco.[${index}].tipos`, value)
                }
              ...
              <DefaultSelect
                ...
                {...register(`endereco.[${index}].resi`)}
                options={tipoResidenciaOption}
                error={errors.endereco?.[index]?.resi?.message}
              />
              <DefaultSelect
                name="tipologradouro"
                label="Tipo Logradouro"
                {...register(`endereco.[${index}].tlogra`)}
                options={tipoLogradouroOption}
                error={errors.endereco?.[index]?.tlogra?.message}
              />
              <DefaultInput
                name="numendereco"
                label="Número"
                {...register(`endereco.[${index}].num`)}
              ...
              <DefaultInput
                name="bairro"
                label="Bairro"
                {...register(`endereco.[${index}].bairro`)}
              ...
              <DefaultInput
                name="cidade"
                label="Cidade"
                {...register(`endereco.[${index}].cidade`)}
              ...
              <DefaultInput
                name="estado"
                label="Estado"
                {...register(`endereco.[${index}].estado`)}
