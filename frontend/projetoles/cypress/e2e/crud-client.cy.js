...
describe("crud cliente", () => {
    it("registrar", () => {
        ...
        cy.get('input[name="endereco.[0].num"]').type(faker.number.int({
            min: 10,
            max: 999
          }))
        ...
        //cartao
        cy.get('input[name="cartao.[0].num"]').type(faker.number.int({
            min: 1000000000000,
            max: 9999999999999
          }))
        cy.get('input[name="cartao.[0].cvc"]').type(faker.number.int({
            min: 100,
            max: 999
          }))
    ...
    it("update", () => {
        ...
        cy.get('input[name="endereco.[0].logra"]').clear().type(faker.location.street())
